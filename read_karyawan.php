...
<html>
<head>
    <title>Data Karyawan - Jawara Jamur</title>
    <style>
        /* CSS INTERNAL */
        body {
...
<body>
    <div class="container">
        ...
        <a href="add_karyawan.php" class="btn-add">+ Tambah Karyawan Baru</a>
        <a href="index.php" style="margin-left: 10px; text-decoration: none; color: #3E2F2C;">← Kembali ke Dashboard</a>
        ...
        <table>
            ...
            <tr>
                ...
                <td><?= $row['status']; ?></td>
                <td>
                    <a href="edit_karyawan.php?id=<?= $row['id_karyawan']; ?>" style="color: blue; text-decoration: none; font-weight: bold;">Edit</a> | 
                    <a href="delete_karyawan.php?id=<?= $row['id_karyawan']; ?>" style="color: red; text-decoration: none; font-weight: bold;" onclick="return confirm('Yakin ingin menghapus karyawan ini?')">Hapus</a>
                </td>
            </tr>
            <?php } ?>
        </table>
